...
export const UI = {
  zh: {
    ...
    skillGuideStep1: 'npx landscape-search',
    skillGuideStep2: '选择你的 AI 编程工具',
    skillGuideStep3: '重启 AI 编程工具',
    skillGuideStep4: '用自然语言搜索项目',
  ...
  en: {
    ...
    skillGuideStep1: 'npx landscape-search',
    skillGuideStep2: 'Pick your AI coding tool',
    skillGuideStep3: 'Restart your AI tool',
    skillGuideStep4: 'Search projects in natural language',
