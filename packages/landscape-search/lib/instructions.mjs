/**
 * Core instruction content for landscape-search.
 * Single source of truth — all tool targets derive their content from this.
 */

export function getCoreInstruction() {
  return `# AI Native Landscape Search
...
\`\`\`bash
curl -s https://landscape.jimmysong.io/exports/projects.json
\`\`\`
...
- Always use the live API URL: https://landscape.jimmysong.io/exports/projects.json
