...
5ire is a cross-platform desktop AI assistant compatible with major providers, supporting local knowledge base and tool extensions. Users can connect various data sources and tools via the MCP protocol to enhance AI application flexibility.
