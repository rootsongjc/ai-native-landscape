...
memU 是由 NevaMind-AI 开发的开源 AI 伴侣记忆框架，专注于解决 AI 伴侣应用中的长期记忆和上下文管理问题。该框架通过先进的记忆管理技术，让 AI 伴侣能够真正“记住”用户的信息、偏好和历史交互，从而提供更加个性化和连贯的服务体验。memU 在 Locomo 基准测试中达到了 92% 的高准确率，同时通过优化策略将成本降低了最高 90%。
